...
//SPI Pins definition
#define PIN_TWI_SDA        Pin_PD1
#define PIN_TWI_SCL        Pin_PD0

static const uint8_t SDA = PIN_TWI_SDA;
static const uint8_t SCL = PIN_TWI_SCL;
